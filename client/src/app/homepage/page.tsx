...
const HomePage  = () => {
  ...
  return (
    <div className='container h-full w-[100%] bg-gray-100 bg-transparent p-8'>
       ...
       <div className='w-auto grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3'>
    {/* First item - Task Priority Distribution */}
